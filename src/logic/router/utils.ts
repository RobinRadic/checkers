 ...
 */
export function getComponent(route:Route|string, routeNodeName:string, routesConfig) {

  const routeName = typeof route === 'object' && route.hasOwnProperty('name') ? route.name : route as string;
